...
do
    ...
    irisOutShader:compileFromFile(nil,Misc.resolveFile("shaders/warpTransition_irisOut.frag"))
    ...
    meltShader:compileFromFile(nil,Misc.resolveFile("shaders/warpTransition_melt.frag"))
