...
local exclamationBlockSettings = {
	...
	outputBlockSpeed = 6,         -- How fast any blocks that come out of this block move.

	outTime = 320, -- How long the blocks that come out of this block last before disappearing.
	blinks = 3,    -- How many times the blocks that come out of this block "blink" before disappearing.
